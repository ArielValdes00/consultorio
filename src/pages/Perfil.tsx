...
export default function Perfil() {
    ...
    function restablecerDatos() {
        const confirmar = window.confirm(
            '¿Restablecer todos los datos de ejemplo? Se van a borrar los turnos, pacientes y atenciones actuales, y se cargan de nuevo con fecha de hoy.'
        )
        if (!confirmar) return
        db.reset()
        ...
        <div>
            ...
            <div className="p-5">
                ...
                <button
                    ...
                    className="rounded-sm border border-status-cancelado bg-transparent px-3.5 py-3 text-sm font-bold text-status-cancelado"
                >
